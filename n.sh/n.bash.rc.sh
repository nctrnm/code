...
#GPL 3 or Later
#nctrnm.com
#Matthew McGilvery Bash Initialization Script
#!/bin/bash/
...
alias hm='cd /sdcard/ && pwd' && alias bashed='vim ~/.bashrc ; cp ~/.bashrc /sdcard/n.git/n.git.sync.sh'
alias d.dir='rm -r'
alias rec='termux-microphone-record -l 0 -e -r 44100  -b 16  wav'
alias n.gt='cd /sdcard/n.git && pwd && exa -h'
alias n.git='source /sdcard/n.git/n.sh/n.git.sync.sh' && alias n.git='source /sdcard/n.git/n.sh/n.git.sync.sh'
