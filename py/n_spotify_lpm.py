...
x = int(int(y)/.0075/12)
z = int(x)/12
print("To earn $" + str(y) + " a year from Spotify, you would need to yield " + str(x) + " streams per month, or " + str(z) + " listeners per month (assuming each listener streams 12 times a month)")
