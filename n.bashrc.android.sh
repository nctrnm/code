...
alias shcp='cp ~/.bashrc /sdcard/nctrnmCODE/n.bashrc.android.sh'
alias sgit='git status' && alias p.git='git push'
alias lsx='exa -bhtx' && alias apps='exa -bad /bin'
alias start='source ~/.bashrc'
alias shed='vim ~/.bashrc ; cp ~/.bashrc /sdcard/nctrnmCODE/n.bashrc.android.sh'
alias dd='rm -rf'
alias rec='termux-microphone-record -l 0 -f /sdcard/rec.tmux/n.${RANDOM}.wav  -r 44100  -b 16'
alias ngt='bash /sdcard/nctrnmCODE/n.sh/git_sync.sh'
alias rm.cache='rm -r $(bash /sdcard/nctrnmCODE/n.sh/n.cache.sh)'
...
alias ncac='bash /sdcard/nctrnmCODE/n.sh/n.cache.sh'
