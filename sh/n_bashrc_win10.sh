...
alias shcp='sudo cp ~/.bashrc /mnt/c/Users/mwmcgilvery/nctrnmCODE/n_bashrc_win10*'
alias sgit='git status' && alias p.git='git push'
alias list='ls -bhtx' && alias apps='ls -b /bin'
alias nb='source ~/.bashrc'
alias nsh='vim ~/.bashrc ; cp ~/.bashrc /mnt/c/Users/mwmcgilvery/nctrnmCODE/n_bashrc_win10**'
alias ddir='rm -r'
...
alias delcac='rm -r $(bash ~/nctrnmCODE/n.sh/n.cache.sh)'
...
alias end='kill -9'
alias nt='vim'
alias wip='cd /mnt/c/wip'
alias home='cd /mnt/c/Users/mwmcgilvery/'
alias ggl="lynx https://google.com/search?q=-"
alias pgit='git push'
alias ntab='tmux new -c ntm'
alias fm='nnn'
cd /mnt/c/Users/mwmcgilvery/nctrnmCODE && bash /mnt/c/Users/mwmcgilvery/nctrnmCODE/n.git.sync.sh && $shcp;
