...
alias ngt='bash /storage/emulated/0/nctrnmCODE/n.sh/git_sync.sh'
alias rm.cache='rm -r $(bash /storage/emulated/0/nctrnmCODE/n.sh/n.cache.sh)'
...
alias ncac='bash /storage/emulated/0/nctrnmCODE/n.sh/n.cache.sh'
