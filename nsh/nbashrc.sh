...
alias and='&&'
alias soxn='sox -r 44100 -b 16 -c 1'
alias cnvrn='ffmpeg -i'
alias send='termux-open --send';
alias instl='apt install';
alias nbn='~/usr/bin';
alias search='apt search';
alias npngb='ping -b -c 8 127.0.0.1 > /sdcard/ngt/nsudo/npngcelnet.txt; nt /sdcard/ngt/nsudo/npngcellular.txt';
alias shcp='cp ~/.bashrc /sdcard/ngt/nsh/nbashrc.sh' && $(ccrypt -e /sdcard/ngt/nsh/nbashrc.sh) ;
...
alias h='/sdcard/ngt'
alias p='ping '
alias flm="cd /emulated/0/'FLM User Files'/'My Samples'/NctrnmSounds"
